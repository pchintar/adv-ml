...
train_dataset = ImageFolder(root=data_dir + '/simba', transform=train_tfms)
valid_dataset = ImageFolder(root=data_dir + '/simba', transform=valid_tfms)
